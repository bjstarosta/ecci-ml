...
-o ${OUT}/tmp_exp/
python ${TOOLS} ${FLAGS} augm \
-i ${OUT}/ECCI53p5No3rotImage3bHD2.tif \
-o ${OUT}/tmp_exp/
python ${TOOLS} ${FLAGS} augm \
-i ${OUT}/ECCI53p5No3rotImage3bHD3.tif \
-o ${OUT}/tmp_exp/
python ${TOOLS} ${FLAGS} augm \
-i ${OUT}/ECCI53p5No3rotImage3bHD1_ground.png \
-o ${OUT}/tmp_ground/
python ${TOOLS} ${FLAGS} augm \
-i ${OUT}/ECCI53p5No3rotImage3bHD2_ground.png \
-o ${OUT}/tmp_ground/
python ${TOOLS} ${FLAGS} augm \
-i ${OUT}/ECCI53p5No3rotImage3bHD3_ground.png \
-o ${OUT}/tmp_ground/
